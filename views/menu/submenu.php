            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $sm['is_active']; ?></td>
                        <td>
                            <a href="" class="badge badge-success" data-toggle="modal" data-target="#ubahSubMenuModal">edit</a>
...
<div class="modal fade" id="ubahSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="ubahSubMenuModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ubahSubMenuModalLabel">Add New Sub Menu</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
